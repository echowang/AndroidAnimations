package cn.com.hwtc.easyanimations.old;
...
import cn.com.hwtc.animations.old.Animation;
import cn.com.hwtc.animations.old.AnimationListener;
import cn.com.hwtc.animations.old.BlindAnimation;
import cn.com.hwtc.animations.old.BlinkAnimation;
import cn.com.hwtc.animations.old.BounceAnimation;
import cn.com.hwtc.animations.old.ExplodeAnimation;
import cn.com.hwtc.animations.old.FadeInAnimation;
import cn.com.hwtc.animations.old.FadeOutAnimation;
import cn.com.hwtc.animations.old.FlipHorizontalAnimation;
import cn.com.hwtc.animations.old.FlipHorizontalToAnimation;
import cn.com.hwtc.animations.old.FlipVerticalAnimation;
import cn.com.hwtc.animations.old.FlipVerticalToAnimation;
import cn.com.hwtc.animations.old.UnfoldAnimation;
import cn.com.hwtc.animations.old.FoldLayout.Orientation;
import cn.com.hwtc.animations.old.FoldAnimation;
import cn.com.hwtc.animations.old.HighlightAnimation;
import cn.com.hwtc.animations.old.ParallelAnimator;
import cn.com.hwtc.animations.old.ParallelAnimatorListener;
import cn.com.hwtc.animations.old.PathAnimation;
import cn.com.hwtc.animations.old.PuffInAnimation;
import cn.com.hwtc.animations.old.PuffOutAnimation;
import cn.com.hwtc.animations.old.RotationAnimation;
import cn.com.hwtc.animations.old.ScaleInAnimation;
import cn.com.hwtc.animations.old.ScaleOutAnimation;
import cn.com.hwtc.animations.old.ShakeAnimation;
import cn.com.hwtc.animations.old.SlideInAnimation;
import cn.com.hwtc.animations.old.SlideInUnderneathAnimation;
import cn.com.hwtc.animations.old.SlideOutAnimation;
import cn.com.hwtc.animations.old.SlideOutUnderneathAnimation;
import cn.com.hwtc.animations.old.TransferAnimation;
import cn.com.hwtc.easyanimations.R;
import cn.com.hwtc.easyanimations.model.DemoItem;
...
public class AnimationDetailFragment extends Fragment implements
		OnClickListener {
	/**
	 * The fragment argument representing the easing_list_item ID that this fragment
	 * represents.
	 */
	...
	public void setUpById(int id) {
		...
		if (id <= 5) {
				card.setImageResource(R.mipmap.img1);
		} else if (id > 5 && id <= 10) {
			card.setImageResource(R.mipmap.img2);
		} else if (id > 10 && id <= 20) {
			card.setImageResource(R.mipmap.img3);
		} else {	
			card.setImageResource(R.mipmap.img4);
		}
		...
		if (id == 14) {
			card.setImageResource(R.mipmap.yellow_star);
			card.setScaleX(0.5f);
			card.setScaleY(0.5f);
		}
