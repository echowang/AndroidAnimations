package cn.com.hwtc.easyanimations.easing;
...
public class EasyingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.easying_activity);
        ...
        mEasingList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                set.playTogether(
                        Glider.glide(s, 1200, ObjectAnimator.ofFloat(mTarget, "translationY", 0, dipToPixels(EasyingActivity.this, -(160 - 3))), new BaseEasingMethod.EasingListener() {
                            @Override
                            public void on(float time, float value, float start, float end, float duration) {
                                mHistory.drawPoint(time, duration, value - dipToPixels(EasyingActivity.this, 60));
                            }
                        })
                );
...
//        getMenuInflater().inflate(R.menu.my, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        // Handle action bar easing_list_item clicks here. The action bar will
