 ...
 * representing easing_list_item details. On tablets, the activity presents the list of
 * items and easing_list_item details side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is
 * {@link AnimationListFragment} and the easing_list_item details (if present) is
 * {@link AnimationDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link AnimationListFragment.Callbacks} interface to listen for easing_list_item
 * selections.
 */
public class AnimationListActivity extends Activity implements
	 ...
	 * that the easing_list_item with the given ID was selected.
	 */
	@Override
	public void onItemSelected(int id) {
		if (mTwoPane) {
			...
			// for the selected easing_list_item ID.
